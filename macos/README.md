...
# 3) Switch to a bundled abstract preset, or import your own pure background
...
A fresh install seeds five procedural abstract presets into your theme library:
**午夜极光 / 樱粉晨曦 / 琥珀黄昏 / 森野薄雾 / 赛博霓虹**. They are generated
with pure Node + zlib and contain no photos, third-party art, or likenesses.
Apply one

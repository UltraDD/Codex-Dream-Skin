...
/bin/mkdir -p "$STANDALONE_ROOT" "$STANDALONE_DOCS/images"
/usr/bin/printf '%s\n' \
  'macos/presets/preset-midnight-aurora/ macos/assets/portal-hero.png macos/NOTICE.md windows/assets/theme.json' \
